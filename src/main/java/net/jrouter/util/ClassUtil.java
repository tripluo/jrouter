...
public class ClassUtil {
    ...
    private static void loadClassesByPackageFile(String packageName, String packagePath, final boolean recursive,
        ...
        for (File file : listFiles) {
            // if directory
            if (file.isDirectory()) {
                loadClassesByPackageFile(packageName + '.' + file.getName(), file.getAbsolutePath(), recursive,
                        classes);
            }
            else {
                // remove .class suffix
    ...
    public static Class<?> loadClass(String className) throws ClassNotFoundException {
        ...
        ClassLoader loader = contextCL == null ? ClassUtil.class.getClassLoader() : contextCL; // NOPMD
