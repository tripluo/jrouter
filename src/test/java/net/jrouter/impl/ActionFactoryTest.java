...
public class ActionFactoryTest {
     ...
     * 测试Action路径的正确性。
     *
     * @see net.jrouter.SimpleAction#simple()
     * @see net.jrouter.SimpleAction#param(java.lang.String, int)
     * @see net.jrouter.SimpleAction#exception() ()
     */
    @Test
    public void test_simple() {
        ...
        assertEquals("100200null", factory.invokeAction(url6, 100, 200));
     ...
     * 测试foward调用。
     *
     * @see net.jrouter.SimpleAction#forward()
     * @see net.jrouter.SimpleAction#forward2()
     */
    @Test
     ...
     * 测试路径全匹配'*'
     *
     * @see net.jrouter.SimpleAction#autoRender(java.lang.String)
     */
    @Test
     ...
     *
     * @see net.jrouter.SimpleAction#inject()
     * @see net.jrouter.interceptor.DemoInterceptor
     * @see net.jrouter.result.DemoResult
     */
    @Test
     ...
     * 测试全局结果对象。
     *
     * @see net.jrouter.SimpleAction#resultNotFound
     * @see net.jrouter.result.DemoResult
     */
    @Test
     ...
     * 测试Action的初始属性。
     *
     * @see net.jrouter.SimpleAction#actionParameters()
     */
    @Test
     ...
     *
     * @see net.jrouter.SimpleAction#actionFilter
     */
    @Test
