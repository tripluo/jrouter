...
public class MultiParameterConverterTest {
     ...
     */
    private static Object[] testConvertMethod(MultiParameterConverter converter, String method, Object[] originalParams,
    ...
    public void testConvert() throws Exception {
        ...
        assertArrayEquals(new Object[] { str1, str2 },
                testConvertMethod(c, "test3", new Object[] { str1, str2, obj }, null));

        assertArrayEquals(new Object[] { obj, str2 }, testConvertMethod(c, "test3", new Object[] { obj, str2 }, null));
        assertArrayEquals(new Object[] { str1, str2 },
                testConvertMethod(c, "test3", new Object[] { str1, obj, str2 }, null));
        assertArrayEquals(new Object[] { str1, str2 },
                testConvertMethod(c, "test3", new Object[] { str1, str2, obj, str2 }, null));
        ...
        assertArrayEquals(new Object[] { str1, str2 },
                testConvertMethod(c, "test4", new Object[] { str1, str2 }, null));
        assertArrayEquals(new Object[] { str1, obj },
                testConvertMethod(c, "test4", new Object[] { obj, sb2, str1, str2 }, null));
        assertArrayEquals(new Object[] { str2, sb2 },
                testConvertMethod(c, "test4", new Object[] { str2, sb2, str1, str2 }, null));
        ...
        assertArrayEquals(new Object[] { str1, sb2 },
                testConvertMethod(c, "test5", new Object[] { str1, sb2, sb1 }, null));
        ...
        assertArrayEquals(new Object[] { str1, str2, null },
                testConvertMethod(c, "test6", new Object[] { str1, str2 }, null));
        assertArrayEquals(new Object[] { str1, str2, null },
                testConvertMethod(c, "test6", new Object[] { obj, str1, str2 }, null));
        assertArrayEquals(new Object[] { str1, str2, null },
                testConvertMethod(c, "test6", new Object[] { null, obj, str1, str2 }, null));
        assertArrayEquals(new Object[] { str1, str2, null },
                testConvertMethod(c, "test6", new Object[] { obj, obj, obj, str1, str2 }, null));
        assertArrayEquals(new Object[] { sb1, sb2, null },
                testConvertMethod(c, "test6", new Object[] { sb1, sb2 }, null));
        assertArrayEquals(new Object[] { sb1, sb2, null },
                testConvertMethod(c, "test6", new Object[] { obj, sb1, sb2 }, null));
        assertArrayEquals(new Object[] { str1, sb2, str2 },
                testConvertMethod(c, "test6", new Object[] { obj, str1, sb2, str2 }, null));
        ...
        assertArrayEquals(new Object[] { 100, new byte[1], new Integer[2], true, null },
                testConvertMethod(c, "test7", new Object[] { 100, new byte[1], new Integer[2], true }, null));
        assertArrayEquals(new Object[] { 100, new byte[1], new Long[2], true, null }, testConvertMethod(c, "test7",
                new Object[] { 100, new byte[1], new Long[2], true, new Object[10] }, null));
        assertArrayEquals(new Object[] { 100, new byte[1], new Number[2], true, new String[10] }, testConvertMethod(c,
                "test7", new Object[] { 100, new byte[1], new Integer[2], true, new String[10] }, null));
        assertArrayEquals(new Object[] { 100, new byte[1], new Integer[2], true, new StringBuilder[10] },
                testConvertMethod(c, "test7",
                        new Object[] { 100, new byte[1], new Integer[2], true, new StringBuilder[10] }, null));
        // error for array match
        // assertArrayEquals(new Object[]{1, new byte[1], new Long[2], true},
        // testConvertMethod(c, "test7", new Object[]{Integer.decode("1"), new Byte[1],
        // new long[2], true}, null));
        assertArrayEquals(new Object[] { 1, new byte[1], new Long[2], true, null }, testConvertMethod(c, "test7",
                new Object[] { Integer.decode("1"), new byte[1], new Long[2], true }, null));
