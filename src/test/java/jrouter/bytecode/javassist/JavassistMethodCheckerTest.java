...
public class JavassistMethodCheckerTest {
    ...
    public void testCheck() throws Exception {
        ...
        assertTrue(new JavassistMethodChecker("**.**").check(method));
        assertTrue(new JavassistMethodChecker("jrouter.ActionInvocation.invoke(**)|jrouter.ActionInvocation.invokeActionOnly(**)").check(method));
        assertTrue(new JavassistMethodChecker("jrouter.ActionInvocation.invoke").check(method));
        assertTrue(new JavassistMethodChecker("jrouter.ActionInvocation.invoke(java.lang.Object[])").check(method));
        assertFalse(new JavassistMethodChecker("jrouter.ActionInvocation.invoke()").check(method));
        assertFalse(new JavassistMethodChecker("jrouter.ActionInvocation.invokeActionOnly(**)").check(method));
        ...
        assertFalse(new JavassistMethodChecker("**&jrouter.ActionInvocation.invoke|NoMethod2|NoMethod3").check(method));
    ...
    public void test_toClassNames() throws Exception {
        ...
        assertArrayEquals(new String[]{"java.lang.String[]"}, toClassNames(method, "([Ljava/lang/String;)"));
        assertArrayEquals(new String[]{"jrouter.ActionInvocation"}, toClassNames(method, "Ljrouter/ActionInvocation;"));
        assertArrayEquals(new String[]{"jrouter.ActionInvocation"}, toClassNames(method, "(Ljrouter/ActionInvocation;)Ljava/lang/Object;"));
